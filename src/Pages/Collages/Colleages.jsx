...
const Colleages = () => {
    ...
    return (
        <div>
            <h2 className="text-3xl text-center font-light mt-6"> Available collages for Admission</h2>
     <div className="grid md:grid-cols-2 lg:grid-cols-3 p-12 gap-6 font-light">
     {
        ...
        <div className="card-body">
          ...
          <div className="">
          <Link to={`/collage/${collage._id}`}> <button className="btn bg-purple-500 text-white btn-outline border-2 flex w-full mx-auto text-center">Details</button></Link>
          </div>
        </div>
      </div>)
       }
